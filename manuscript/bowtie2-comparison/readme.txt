#/project/flatiron2/sop/bowtie2 -x bt2/97_otus -1 seqs.fna --np 1 --rfg 0,1 --rdg 0,1 --mp 1,1 --score-min "L,0,-1"
...
echo "Searfch with BURST using CAPITALIST..."
...
/project/flatiron2/sop/bowtie2-build /project/flatiron/dan/gg_13_8/gg_13_8_otus/rep_set/97_otus.fasta 97_otus --threads 96
echo "Running BT2..."
...
echo "tallying hits..."
#python tally_correct_hits_by_pct_id.py gg97_capitalist.txt gg97_capitalist.txt /project/flatiron/dan/gg_13_8/gg_13_8_otus/taxonomy/97_otu_taxonomy.txt bt2.sam tally.txt
